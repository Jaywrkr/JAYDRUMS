...
3. **Práctica**: motor de juego con carriles por pieza. Las notas bajan sincronizadas al patrón elegido (definido en `src/lessons.ts`) y se evalúan contra los golpes reales usando el mapa calibrado (perfecto ±30 ms, bien ±70 ms, flojo ±150 ms). Muestra puntaje, racha y precisión.
